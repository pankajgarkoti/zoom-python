...
class TSPAccountsList1(object):
    ...
    def __init__(self, id=None, conference_code=None, dial_in_numbers=None, leader_pin=None, tsp_bridge=None):  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this TSPAccountsList1.  # noqa: E501

        The ID of the TSP account.  # noqa: E501

        :return: The id of this TSPAccountsList1.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this TSPAccountsList1.

        The ID of the TSP account.  # noqa: E501

        :param id: The id of this TSPAccountsList1.  # noqa: E501
        :type: str
        """
