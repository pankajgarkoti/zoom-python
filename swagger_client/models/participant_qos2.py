...
class ParticipantQOS2(object):
    ...
    def __init__(self, id=None, device=None, domain=None, harddisk_id=None, internal_ip_addresses=None, ip_address=None, join_time=None, leave_time=None, location=None, mac_addr=None, pc_name=None, user_id=None, user_name=None, user_qos=None, version=None):  # noqa: E501
        """ParticipantQOS2 - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._device = None
        self._domain = None
    ...
    @property
    def id(self):
        """Gets the id of this ParticipantQOS2.  # noqa: E501
        ...
        :return: The id of this ParticipantQOS2.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ParticipantQOS2.

        The participant's universally unique ID. This value is the same as the participant's user ID if the participant joins the webinar by logging into Zoom. If the participant joins the webinar without logging into Zoom, this returns an empty value.  # noqa: E501

        :param id: The id of this ParticipantQOS2.  # noqa: E501
        :type: str
        """
    ...
    @property
    def device(self):
        """Gets the device of this ParticipantQOS2.  # noqa: E501
        ...
        :return: The device of this ParticipantQOS2.  # noqa: E501
        :rtype: str
        """
        return self._device
    ...
    def device(self, device):
        """Sets the device of this ParticipantQOS2.

        The type of device the participant used to join the meeting.  * `Phone` - The participant joined via PSTN.  * `H.323/SIP` - The participant joined via an H.323 or SIP device.  * `Windows` - The participant joined via VoIP using a Windows device.  * `Mac` - The participant joined via VoIP using a Mac device.  * `iOS` - The participant joined via VoIP using an iOS device.  * `Android` - The participant joined via VoIP using an Android device.   **Note:** This response returns an empty string (`&ldquo;&ldquo;`) value for any users who are **not** a part of the host's account (external users).  # noqa: E501

        :param device: The device of this ParticipantQOS2.  # noqa: E501
        :type: str
        """
    ...
    @property
    def domain(self):
        """Gets the domain of this ParticipantQOS2.  # noqa: E501
        ...
        :return: The domain of this ParticipantQOS2.  # noqa: E501
        :rtype: str
        """
        return self._domain
    ...
    def domain(self, domain):
        """Sets the domain of this ParticipantQOS2.

        The participant's PC domain.   **Note:** This response returns an empty string (`&ldquo;&ldquo;`) value for any users who are **not** a part of the host's account (external users).  # noqa: E501

        :param domain: The domain of this ParticipantQOS2.  # noqa: E501
        :type: str
        """
    ...
    def harddisk_id(self):
        """Gets the harddisk_id of this ParticipantQOS2.  # noqa: E501
        ...
        :return: The harddisk_id of this ParticipantQOS2.  # noqa: E501
        :rtype: str
        """
    ...
    def harddisk_id(self, harddisk_id):
        """Sets the harddisk_id of this ParticipantQOS2.

        The participant's hard disk ID.   **Note:** This response returns an empty string (`&ldquo;&ldquo;`) value for any users who are **not** a part of the host's account (external users).  # noqa: E501

        :param harddisk_id: The harddisk_id of this ParticipantQOS2.  # noqa: E501
        :type: str
        """
    ...
    def internal_ip_addresses(self):
        """Gets the internal_ip_addresses of this ParticipantQOS2.  # noqa: E501
        ...
        :return: The internal_ip_addresses of this ParticipantQOS2.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def internal_ip_addresses(self, internal_ip_addresses):
        """Sets the internal_ip_addresses of this ParticipantQOS2.

        The participant's internal IP addresses. This field will not return under these conditions:  * The account calling this API is a **legacy** [business associate agreement (BAA) under HIPAA](https://www.ecfr.gov/cgi-bin/retrieveECFR?gp=1&amp;n=se45.1.160_1103&amp;r=SECTION&amp;ty=HTML).  * The account calling this API is a BAA under HIPAA **without** a signed BAA data processing addendum.  # noqa: E501

        :param internal_ip_addresses: The internal_ip_addresses of this ParticipantQOS2.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def ip_address(self):
        """Gets the ip_address of this ParticipantQOS2.  # noqa: E501

        The participant's IP address.  # noqa: E501

        :return: The ip_address of this ParticipantQOS2.  # noqa: E501
        :rtype: str
        """
    ...
    def ip_address(self, ip_address):
        """Sets the ip_address of this ParticipantQOS2.

        The participant's IP address.  # noqa: E501

        :param ip_address: The ip_address of this ParticipantQOS2.  # noqa: E501
        :type: str
        """
    ...
    @property
    def join_time(self):
        """Gets the join_time of this ParticipantQOS2.  # noqa: E501

        The time when the participant joined the meeting.  # noqa: E501

        :return: The join_time of this ParticipantQOS2.  # noqa: E501
        :rtype: datetime
        """
    ...
    def join_time(self, join_time):
        """Sets the join_time of this ParticipantQOS2.

        The time when the participant joined the meeting.  # noqa: E501

        :param join_time: The join_time of this ParticipantQOS2.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def leave_time(self):
        """Gets the leave_time of this ParticipantQOS2.  # noqa: E501

        The time when the participant left the meeting.  # noqa: E501

        :return: The leave_time of this ParticipantQOS2.  # noqa: E501
        :rtype: datetime
        """
    ...
    def leave_time(self, leave_time):
        """Sets the leave_time of this ParticipantQOS2.

        The time when the participant left the meeting.  # noqa: E501

        :param leave_time: The leave_time of this ParticipantQOS2.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def location(self):
        """Gets the location of this ParticipantQOS2.  # noqa: E501

        The participant's location.  # noqa: E501

        :return: The location of this ParticipantQOS2.  # noqa: E501
        :rtype: str
        """
    ...
    def location(self, location):
        """Sets the location of this ParticipantQOS2.

        The participant's location.  # noqa: E501

        :param location: The location of this ParticipantQOS2.  # noqa: E501
        :type: str
        """
    ...
    @property
    def mac_addr(self):
        """Gets the mac_addr of this ParticipantQOS2.  # noqa: E501
        ...
        :return: The mac_addr of this ParticipantQOS2.  # noqa: E501
        :rtype: str
        """
    ...
    def mac_addr(self, mac_addr):
        """Sets the mac_addr of this ParticipantQOS2.

        The participant's MAC address.   **Note:** This response returns an empty string (`&ldquo;&ldquo;`) value for any users who are **not** a part of the host's account (external users).  # noqa: E501

        :param mac_addr: The mac_addr of this ParticipantQOS2.  # noqa: E501
        :type: str
        """
    ...
    @property
    def pc_name(self):
        """Gets the pc_name of this ParticipantQOS2.  # noqa: E501

        The participant's PC name.  # noqa: E501

        :return: The pc_name of this ParticipantQOS2.  # noqa: E501
        :rtype: str
        """
    ...
    def pc_name(self, pc_name):
        """Sets the pc_name of this ParticipantQOS2.

        The participant's PC name.  # noqa: E501

        :param pc_name: The pc_name of this ParticipantQOS2.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_id(self):
        """Gets the user_id of this ParticipantQOS2.  # noqa: E501
        ...
        :return: The user_id of this ParticipantQOS2.  # noqa: E501
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this ParticipantQOS2.

        The participant's ID. This value is assigned to a participant upon joining a meeting and is only valid for the meeting's duration.  # noqa: E501

        :param user_id: The user_id of this ParticipantQOS2.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_name(self):
        """Gets the user_name of this ParticipantQOS2.  # noqa: E501

        The participant's display name.  # noqa: E501

        :return: The user_name of this ParticipantQOS2.  # noqa: E501
        :rtype: str
        """
    ...
    def user_name(self, user_name):
        """Sets the user_name of this ParticipantQOS2.

        The participant's display name.  # noqa: E501

        :param user_name: The user_name of this ParticipantQOS2.  # noqa: E501
        :type: str
        """
    ...
    @property
    def user_qos(self):
        """Gets the user_qos of this ParticipantQOS2.  # noqa: E501

        The participant's quality of service information.  # noqa: E501

        :return: The user_qos of this ParticipantQOS2.  # noqa: E501
    ...
    def user_qos(self, user_qos):
        """Sets the user_qos of this ParticipantQOS2.

        The participant's quality of service information.  # noqa: E501

        :param user_qos: The user_qos of this ParticipantQOS2.  # noqa: E501
    ...
    @property
    def version(self):
        """Gets the version of this ParticipantQOS2.  # noqa: E501

        The participant's Zoom client version.  # noqa: E501

        :return: The version of this ParticipantQOS2.  # noqa: E501
        :rtype: str
        """
    ...
    def version(self, version):
        """Sets the version of this ParticipantQOS2.

        The participant's Zoom client version.  # noqa: E501

        :param version: The version of this ParticipantQOS2.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ParticipantQOS2, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ParticipantQOS2):
            return False
