...
class WebinarswebinarIdSettingsQuestionAndAnswer(object):
    ...
    def __init__(self, allow_submit_questions=None, allow_anonymous_questions=None, answer_questions=None, attendees_can_comment=None, attendees_can_upvote=None, allow_auto_reply=None, auto_reply_text=None, enable=None):  # noqa: E501
        """WebinarswebinarIdSettingsQuestionAndAnswer - a model defined in Swagger"""  # noqa: E501
    ...
    def allow_submit_questions(self):
        """Gets the allow_submit_questions of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501

        * `true` - Allow participants to submit questions.  * `false` - Do not allow submit questions.  # noqa: E501

        :return: The allow_submit_questions of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_submit_questions(self, allow_submit_questions):
        """Sets the allow_submit_questions of this WebinarswebinarIdSettingsQuestionAndAnswer.

        * `true` - Allow participants to submit questions.  * `false` - Do not allow submit questions.  # noqa: E501

        :param allow_submit_questions: The allow_submit_questions of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        :type: bool
        """
    ...
    def allow_anonymous_questions(self):
        """Gets the allow_anonymous_questions of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        ...
        * `true` - Allow participants to send questions without providing their name to the host, co-host, and panelists..  * `false` - Do not allow anonymous questions.  # noqa: E501
        ...
        :return: The allow_anonymous_questions of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_anonymous_questions(self, allow_anonymous_questions):
        """Sets the allow_anonymous_questions of this WebinarswebinarIdSettingsQuestionAndAnswer.

        * `true` - Allow participants to send questions without providing their name to the host, co-host, and panelists..  * `false` - Do not allow anonymous questions.  # noqa: E501

        :param allow_anonymous_questions: The allow_anonymous_questions of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        :type: bool
        """
    ...
    def answer_questions(self):
        """Gets the answer_questions of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        ...
        :return: The answer_questions of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        :rtype: str
        """
    ...
    def answer_questions(self, answer_questions):
        """Sets the answer_questions of this WebinarswebinarIdSettingsQuestionAndAnswer.

        Indicate whether you want attendees to be able to view answered questions only or view all questions.  * `only` - Attendees are able to view answered questions only.  *  `all` - Attendees are able to view all questions submitted in the Q&amp;A.  # noqa: E501

        :param answer_questions: The answer_questions of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        :type: str
        """
    ...
    def attendees_can_comment(self):
        """Gets the attendees_can_comment of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501

        * `true` - Attendees can answer questions or leave a comment in the question thread.  * `false` - Attendees can't answer questions or leave a comment in the question thread.  # noqa: E501

        :return: The attendees_can_comment of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        :rtype: bool
        """
    ...
    def attendees_can_comment(self, attendees_can_comment):
        """Sets the attendees_can_comment of this WebinarswebinarIdSettingsQuestionAndAnswer.

        * `true` - Attendees can answer questions or leave a comment in the question thread.  * `false` - Attendees can't answer questions or leave a comment in the question thread.  # noqa: E501

        :param attendees_can_comment: The attendees_can_comment of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        :type: bool
        """
    ...
    def attendees_can_upvote(self):
        """Gets the attendees_can_upvote of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501

        * `true` - Attendees can click the thumbs up button to bring popular questions to the top of the Q&amp;A window.  * `false` - Attendees can't click the thumbs up button on questions.  # noqa: E501

        :return: The attendees_can_upvote of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        :rtype: bool
        """
    ...
    def attendees_can_upvote(self, attendees_can_upvote):
        """Sets the attendees_can_upvote of this WebinarswebinarIdSettingsQuestionAndAnswer.

        * `true` - Attendees can click the thumbs up button to bring popular questions to the top of the Q&amp;A window.  * `false` - Attendees can't click the thumbs up button on questions.  # noqa: E501

        :param attendees_can_upvote: The attendees_can_upvote of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        :type: bool
        """
    ...
    def allow_auto_reply(self):
        """Gets the allow_auto_reply of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501

        If simulive webinar,   * `true` - allow auto-reply to attendees.   * `false` - don't allow auto-reply to the attendees.  # noqa: E501

        :return: The allow_auto_reply of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_auto_reply(self, allow_auto_reply):
        """Sets the allow_auto_reply of this WebinarswebinarIdSettingsQuestionAndAnswer.

        If simulive webinar,   * `true` - allow auto-reply to attendees.   * `false` - don't allow auto-reply to the attendees.  # noqa: E501

        :param allow_auto_reply: The allow_auto_reply of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        :type: bool
        """
    ...
    def auto_reply_text(self):
        """Gets the auto_reply_text of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501

        If `allow_auto_reply` = true, the text to be included in the automatic response.   # noqa: E501

        :return: The auto_reply_text of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        :rtype: str
        """
    ...
    def auto_reply_text(self, auto_reply_text):
        """Sets the auto_reply_text of this WebinarswebinarIdSettingsQuestionAndAnswer.

        If `allow_auto_reply` = true, the text to be included in the automatic response.   # noqa: E501

        :param auto_reply_text: The auto_reply_text of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        :type: str
        """
    ...
    @property
    def enable(self):
        """Gets the enable of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        ...
        * `true` - Enable [Q&amp;A](https://support.zoom.us/hc/en-us/articles/203686015-Using-Q-A-as-the-webinar-host#:~:text=Overview,and%20upvote%20each%20other's%20questions.) for webinar.  * `false` - Disable Q&amp;A for webinar.  # noqa: E501
        ...
        :return: The enable of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        :rtype: bool
        """
        return self._enable
    ...
    def enable(self, enable):
        """Sets the enable of this WebinarswebinarIdSettingsQuestionAndAnswer.

        * `true` - Enable [Q&amp;A](https://support.zoom.us/hc/en-us/articles/203686015-Using-Q-A-as-the-webinar-host#:~:text=Overview,and%20upvote%20each%20other's%20questions.) for webinar.  * `false` - Disable Q&amp;A for webinar.  # noqa: E501

        :param enable: The enable of this WebinarswebinarIdSettingsQuestionAndAnswer.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WebinarswebinarIdSettingsQuestionAndAnswer, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WebinarswebinarIdSettingsQuestionAndAnswer):
            return False
