...
class WebinarSurveyObject1(object):
    ...
    """
    swagger_types = {
        'custom_survey': 'WebinarswebinarIdsurveyCustomSurvey',
    ...
    def __init__(self, custom_survey=None, show_in_the_browser=True, show_in_the_follow_up_email=False, third_party_survey=None):  # noqa: E501
        """WebinarSurveyObject1 - a model defined in Swagger"""  # noqa: E501
    ...
    def custom_survey(self):
        """Gets the custom_survey of this WebinarSurveyObject1.  # noqa: E501


        :return: The custom_survey of this WebinarSurveyObject1.  # noqa: E501
        :rtype: WebinarswebinarIdsurveyCustomSurvey
        """
        return self._custom_survey

    @custom_survey.setter
    def custom_survey(self, custom_survey):
        """Sets the custom_survey of this WebinarSurveyObject1.


        :param custom_survey: The custom_survey of this WebinarSurveyObject1.  # noqa: E501
        :type: WebinarswebinarIdsurveyCustomSurvey
        """
    ...
    def show_in_the_browser(self):
        """Gets the show_in_the_browser of this WebinarSurveyObject1.  # noqa: E501
        ...
        :return: The show_in_the_browser of this WebinarSurveyObject1.  # noqa: E501
        :rtype: bool
        """
    ...
    def show_in_the_browser(self, show_in_the_browser):
        """Sets the show_in_the_browser of this WebinarSurveyObject1.

        Whether the **Show in the browser when the webinar ends** option is enabled.  * `true` - Enabled.  * `false` - Disabled.    This value defaults to `true`.  # noqa: E501

        :param show_in_the_browser: The show_in_the_browser of this WebinarSurveyObject1.  # noqa: E501
        :type: bool
        """
    ...
    def show_in_the_follow_up_email(self):
        """Gets the show_in_the_follow_up_email of this WebinarSurveyObject1.  # noqa: E501
        ...
        :return: The show_in_the_follow_up_email of this WebinarSurveyObject1.  # noqa: E501
        :rtype: bool
        """
    ...
    def show_in_the_follow_up_email(self, show_in_the_follow_up_email):
        """Sets the show_in_the_follow_up_email of this WebinarSurveyObject1.

        Whether the **Show the link on the follow-up email** option is enabled.  * `true` - Enabled.  * `false` - Disabled.    This value defaults to `false`.  # noqa: E501

        :param show_in_the_follow_up_email: The show_in_the_follow_up_email of this WebinarSurveyObject1.  # noqa: E501
        :type: bool
        """
    ...
    def third_party_survey(self):
        """Gets the third_party_survey of this WebinarSurveyObject1.  # noqa: E501

        The link to the third party webinar survey.  # noqa: E501

        :return: The third_party_survey of this WebinarSurveyObject1.  # noqa: E501
        :rtype: str
        """
    ...
    def third_party_survey(self, third_party_survey):
        """Sets the third_party_survey of this WebinarSurveyObject1.

        The link to the third party webinar survey.  # noqa: E501

        :param third_party_survey: The third_party_survey of this WebinarSurveyObject1.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WebinarSurveyObject1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WebinarSurveyObject1):
            return False
