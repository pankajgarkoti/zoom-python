...
class AccountsaccountIdsettingsInSession(object):
    ...
    def __init__(self, custom_data_center_regions=None, data_center_regions=None, p2p_connetion=None, p2p_ports=None, ports_range='', dscp_audio=56, dscp_marking=None, dscp_video=40, dscp_dual=None, subsession=None):  # noqa: E501
        """AccountsaccountIdsettingsInSession - a model defined in Swagger"""  # noqa: E501
    ...
    def custom_data_center_regions(self):
        """Gets the custom_data_center_regions of this AccountsaccountIdsettingsInSession.  # noqa: E501
        ...
        :return: The custom_data_center_regions of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :rtype: bool
        """
    ...
    def custom_data_center_regions(self, custom_data_center_regions):
        """Sets the custom_data_center_regions of this AccountsaccountIdsettingsInSession.

        Whether to use custom [data center regions](https://support.zoom.us/hc/en-us/articles/360042411451-Selecting-data-center-regions-for-meetings-webinars).  * `true` - Users can [select data center regions](https://support.zoom.us/hc/en-us/articles/360042411451-Selecting-data-center-regions-for-hosted-meetings-and-webinars) to use for hosting real-time meeting traffic. The data center regions can be provided in the `data_center_regions` field.  * `false` - Only use the default data center regions.  # noqa: E501

        :param custom_data_center_regions: The custom_data_center_regions of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :type: bool
        """
    ...
    def data_center_regions(self):
        """Gets the data_center_regions of this AccountsaccountIdsettingsInSession.  # noqa: E501
        ...
        :return: The data_center_regions of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def data_center_regions(self, data_center_regions):
        """Sets the data_center_regions of this AccountsaccountIdsettingsInSession.

        If the value of `custom_data_center_regions` is `true`, a comma-separated list of the following [data center regions](https://support.zoom.us/hc/en-us/articles/360059254691-Datacenter-abbreviation-list) to opt in to.  * `AU` - Australia. * `LA` - Latin America.  * `CA` - Canada.  * `CN` - China.  * `DE` - Germany.  * `HK` - Hong Kong SAR.  * `IN` - India.  * `IE` - Ireland.  * `TY` - Japan.  * `MX` - Mexico.  * `NL` - Netherlands.  * `SG` - Singapore.  * `US` - United States.  # noqa: E501

        :param data_center_regions: The data_center_regions of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :type: list[str]
        """
    ...
    def p2p_connetion(self):
        """Gets the p2p_connetion of this AccountsaccountIdsettingsInSession.  # noqa: E501
        ...
        :return: The p2p_connetion of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :rtype: bool
        """
    ...
    def p2p_connetion(self, p2p_connetion):
        """Sets the p2p_connetion of this AccountsaccountIdsettingsInSession.

        Whether to enable the [**Peer to Peer connection while only 2 people are in a meeting**](https://support.zoom.us/hc/en-us/articles/360061410851-Enabling-Peer-to-Peer-connection-for-2-people-in-a-meeting) setting.  # noqa: E501

        :param p2p_connetion: The p2p_connetion of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def p2p_ports(self):
        """Gets the p2p_ports of this AccountsaccountIdsettingsInSession.  # noqa: E501

        Whether to enable the **Listening ports range** setting.  # noqa: E501

        :return: The p2p_ports of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :rtype: bool
        """
    ...
    def p2p_ports(self, p2p_ports):
        """Sets the p2p_ports of this AccountsaccountIdsettingsInSession.

        Whether to enable the **Listening ports range** setting.  # noqa: E501

        :param p2p_ports: The p2p_ports of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :type: bool
        """
    ...
    def ports_range(self):
        """Gets the ports_range of this AccountsaccountIdsettingsInSession.  # noqa: E501
        ...
        :return: The ports_range of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :rtype: str
        """
    ...
    def ports_range(self, ports_range):
        """Sets the ports_range of this AccountsaccountIdsettingsInSession.

        When the `p2p_ports` value is `true`, the value is a semi-colon list of the peer to peer listening ports range, between `1` to `65535`. This value defaults to an empty string.  # noqa: E501

        :param ports_range: The ports_range of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :type: str
        """
    ...
    @property
    def dscp_audio(self):
        """Gets the dscp_audio of this AccountsaccountIdsettingsInSession.  # noqa: E501

        The DSCP audio marking value. This value defaults to `56`.  # noqa: E501

        :return: The dscp_audio of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :rtype: int
        """
    ...
    def dscp_audio(self, dscp_audio):
        """Sets the dscp_audio of this AccountsaccountIdsettingsInSession.

        The DSCP audio marking value. This value defaults to `56`.  # noqa: E501

        :param dscp_audio: The dscp_audio of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :type: int
        """
    ...
    def dscp_marking(self):
        """Gets the dscp_marking of this AccountsaccountIdsettingsInSession.  # noqa: E501
        ...
        :return: The dscp_marking of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :rtype: bool
        """
    ...
    def dscp_marking(self, dscp_marking):
        """Sets the dscp_marking of this AccountsaccountIdsettingsInSession.

        Whether to enable [differentiated services code point (DSCP)](https://en.wikipedia.org/wiki/Differentiated_services) marking.  # noqa: E501

        :param dscp_marking: The dscp_marking of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def dscp_video(self):
        """Gets the dscp_video of this AccountsaccountIdsettingsInSession.  # noqa: E501

        The DSCP video marking value. This value defaults to `40`.  # noqa: E501

        :return: The dscp_video of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :rtype: int
        """
    ...
    def dscp_video(self, dscp_video):
        """Sets the dscp_video of this AccountsaccountIdsettingsInSession.

        The DSCP video marking value. This value defaults to `40`.  # noqa: E501

        :param dscp_video: The dscp_video of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :type: int
        """
    ...
    @property
    def dscp_dual(self):
        """Gets the dscp_dual of this AccountsaccountIdsettingsInSession.  # noqa: E501
        ...
        :return: The dscp_dual of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :rtype: bool
        """
    ...
    def dscp_dual(self, dscp_dual):
        """Sets the dscp_dual of this AccountsaccountIdsettingsInSession.

        Whether to use the differentiated services code point classifiers ('dscp_video', 'dscp_audio') in the dual way (incoming and outgoing).  # noqa: E501

        :param dscp_dual: The dscp_dual of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def subsession(self):
        """Gets the subsession of this AccountsaccountIdsettingsInSession.  # noqa: E501

        Allow host to split meeting participants into separate, smaller rooms.  # noqa: E501

        :return: The subsession of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :rtype: bool
        """
    ...
    def subsession(self, subsession):
        """Sets the subsession of this AccountsaccountIdsettingsInSession.

        Allow host to split meeting participants into separate, smaller rooms.  # noqa: E501

        :param subsession: The subsession of this AccountsaccountIdsettingsInSession.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AccountsaccountIdsettingsInSession, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccountsaccountIdsettingsInSession):
            return False
