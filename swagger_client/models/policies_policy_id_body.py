...
class PoliciesPolicyIdBody(object):
    ...
    def __init__(self, assigned_group_id=None, id=None, policy_name=None, settings=None, status=None, to_group_id=None, type=TypeEnum._0):  # noqa: E501
        """PoliciesPolicyIdBody - a model defined in Swagger"""  # noqa: E501
    ...
    def assigned_group_id(self):
        """Gets the assigned_group_id of this PoliciesPolicyIdBody.  # noqa: E501

        The assigner group's (Group 1) ID.  # noqa: E501

        :return: The assigned_group_id of this PoliciesPolicyIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def assigned_group_id(self, assigned_group_id):
        """Sets the assigned_group_id of this PoliciesPolicyIdBody.

        The assigner group's (Group 1) ID.  # noqa: E501

        :param assigned_group_id: The assigned_group_id of this PoliciesPolicyIdBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this PoliciesPolicyIdBody.  # noqa: E501

        The Information Barriers policy's ID.  # noqa: E501

        :return: The id of this PoliciesPolicyIdBody.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this PoliciesPolicyIdBody.

        The Information Barriers policy's ID.  # noqa: E501

        :param id: The id of this PoliciesPolicyIdBody.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    def policy_name(self):
        """Gets the policy_name of this PoliciesPolicyIdBody.  # noqa: E501

        The Information Barriers policy's name.  # noqa: E501

        :return: The policy_name of this PoliciesPolicyIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def policy_name(self, policy_name):
        """Sets the policy_name of this PoliciesPolicyIdBody.

        The Information Barriers policy's name.  # noqa: E501

        :param policy_name: The policy_name of this PoliciesPolicyIdBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def settings(self):
        """Gets the settings of this PoliciesPolicyIdBody.  # noqa: E501


        :return: The settings of this PoliciesPolicyIdBody.  # noqa: E501
    ...
    def settings(self, settings):
        """Sets the settings of this PoliciesPolicyIdBody.


        :param settings: The settings of this PoliciesPolicyIdBody.  # noqa: E501
    ...
    @property
    def status(self):
        """Gets the status of this PoliciesPolicyIdBody.  # noqa: E501

        The Information Barriers policy's status.  * `0` &mdash; Disabled.  * `1` &mdash; Enabled.  # noqa: E501

        :return: The status of this PoliciesPolicyIdBody.  # noqa: E501
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this PoliciesPolicyIdBody.

        The Information Barriers policy's status.  * `0` &mdash; Disabled.  * `1` &mdash; Enabled.  # noqa: E501

        :param status: The status of this PoliciesPolicyIdBody.  # noqa: E501
        :type: int
        """
        if status is None:
    ...
    def to_group_id(self):
        """Gets the to_group_id of this PoliciesPolicyIdBody.  # noqa: E501

        The assignee group's (Group 2) ID.  # noqa: E501

        :return: The to_group_id of this PoliciesPolicyIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def to_group_id(self, to_group_id):
        """Sets the to_group_id of this PoliciesPolicyIdBody.

        The assignee group's (Group 2) ID.  # noqa: E501

        :param to_group_id: The to_group_id of this PoliciesPolicyIdBody.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this PoliciesPolicyIdBody.  # noqa: E501
        ...
        :return: The type of this PoliciesPolicyIdBody.  # noqa: E501
        :rtype: int
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this PoliciesPolicyIdBody.

        The Information Barriers policy's type of `settings` restrictions.  * `0` &mdash; A [hard or soft block](https://support.zoom.us/hc/en-us/articles/360040913711-Information-Barriers#h_a603c6f7-05c8-4de5-b4b6-91982d748b34) exists, but users in Group 1 and Group 2 can chat with each other.  * `1` &mdash; A [hard or soft block](https://support.zoom.us/hc/en-us/articles/360040913711-Information-Barriers#h_a603c6f7-05c8-4de5-b4b6-91982d748b34) exists and only users in Group 1 can chat with users in Group 2.  * `2` &mdash; No blocks exist, but only users in Group 1 can chat with users in Group 2.  * `3` &mdash; No blocks exist and users in Group 1 and Group 2 can chat with each other.   This field only supports `0`.  # noqa: E501

        :param type: The type of this PoliciesPolicyIdBody.  # noqa: E501
        :type: int
        """
        if type is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PoliciesPolicyIdBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PoliciesPolicyIdBody):
            return False
