...
class TSPApi(object):
    ...
    def tsp(self, **kwargs):  # noqa: E501
        ...
        Get information on Telephony Service Provider on an account level.         **Prerequisites:**     * A Pro or a higher plan.  **Scopes:** `tsp:read:admin`  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Light`  # noqa: E501
    ...
    def tsp_update(self, **kwargs):  # noqa: E501
        """Update account's TSP information  # noqa: E501

        Update information of the Telephony Service Provider set up on an account.     **Prerequisites**:     TSP account option should be enabled.       **Scopes:** `tsp:write:admin`  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Light`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.tsp_update(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param TspBody body: TSP Account
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.tsp_update_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.tsp_update_with_http_info(**kwargs)  # noqa: E501
            return data

    def tsp_update_with_http_info(self, **kwargs):  # noqa: E501
        """Update account's TSP information  # noqa: E501

        Update information of the Telephony Service Provider set up on an account.     **Prerequisites**:     TSP account option should be enabled.       **Scopes:** `tsp:write:admin`  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Light`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.tsp_update_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def user_tsp(self, user_id, tsp_id, **kwargs):  # noqa: E501
        ...
        Each user can have a maximum of two TSP accounts. Use this API to retrieve details of a specific TSP account enabled for a specific user.           **Scopes:** `tsp:read:admin`,`tsp:read`  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Light`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param UserId4 user_id: The user ID or email address of the user. For user-level apps, pass the `me` value. (required)
    ...
    def user_tsp_create(self, user_id, **kwargs):  # noqa: E501
        """Add a user's TSP account  # noqa: E501

        Add a user's TSP account.           **Scopes:** `tsp:write:admin`,`tsp:write`  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Light`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_tsp_create(user_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UserId3 user_id: The user ID or email address of the user. For user-level apps, pass the `me` value. (required)
        :param TSPAccountsList body: TSP account.
        :return: TSPAccountsList1
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.user_tsp_create_with_http_info(user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.user_tsp_create_with_http_info(user_id, **kwargs)  # noqa: E501
            return data

    def user_tsp_create_with_http_info(self, user_id, **kwargs):  # noqa: E501
        """Add a user's TSP account  # noqa: E501

        Add a user's TSP account.           **Scopes:** `tsp:write:admin`,`tsp:write`  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Light`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_tsp_create_with_http_info(user_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='TSPAccountsList1',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def user_tsp_delete(self, user_id, tsp_id, **kwargs):  # noqa: E501
        ...
        Delete a user's TSP account.           **Scopes:** `tsp:write:admin`,`tsp:write`  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Light`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param UserId5 user_id: The user ID or email address of the user. For user-level apps, pass the `me` value. (required)
        :param str tsp_id: TSP account ID. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def user_tsp_update(self, user_id, tsp_id, **kwargs):  # noqa: E501
        """Update a TSP account  # noqa: E501

        Update a user's TSP account.           **Scopes:** `tsp:write:admin`,`tsp:write`  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Light`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_tsp_update(user_id, tsp_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UserId6 user_id: The user ID or email address of the user. For user-level apps, pass the `me` value. (required)
        :param str tsp_id: TSP account ID. (required)
        :param TSPAccount1 body: TSP account.
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.user_tsp_update_with_http_info(user_id, tsp_id, **kwargs)  # noqa: E501
        else:
            (data) = self.user_tsp_update_with_http_info(user_id, tsp_id, **kwargs)  # noqa: E501
            return data

    def user_tsp_update_with_http_info(self, user_id, tsp_id, **kwargs):  # noqa: E501
        """Update a TSP account  # noqa: E501

        Update a user's TSP account.           **Scopes:** `tsp:write:admin`,`tsp:write`  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Light`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_tsp_update_with_http_info(user_id, tsp_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['user_id', 'tsp_id', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def user_tsps(self, user_id, **kwargs):  # noqa: E501
        """List user's TSP accounts  # noqa: E501

        A user can have a maximum of two TSP accounts. Use this API to list all TSP accounts of a user.           **Scopes:** `tsp:read:admin`,`tsp:read`  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Medium`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_tsps(user_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UserId2 user_id: The user ID or email address of the user. For user-level apps, pass the `me` value. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.user_tsps_with_http_info(user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.user_tsps_with_http_info(user_id, **kwargs)  # noqa: E501
            return data

    def user_tsps_with_http_info(self, user_id, **kwargs):  # noqa: E501
        """List user's TSP accounts  # noqa: E501

        A user can have a maximum of two TSP accounts. Use this API to list all TSP accounts of a user.           **Scopes:** `tsp:read:admin`,`tsp:read`  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Medium`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_tsps_with_http_info(user_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('user_id' not in params or
                params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `user_tsps`")  # noqa: E501
