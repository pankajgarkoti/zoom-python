...
class InlineResponse2002SecurityPasswordRequirement(object):
    ...
    def __init__(self, consecutive_characters_length=None, have_special_character=None, minimum_password_length=None, weak_enhance_detection=None):  # noqa: E501
        """InlineResponse2002SecurityPasswordRequirement - a model defined in Swagger"""  # noqa: E501
    ...
    def consecutive_characters_length(self):
        """Gets the consecutive_characters_length of this InlineResponse2002SecurityPasswordRequirement.  # noqa: E501
        ...
        :return: The consecutive_characters_length of this InlineResponse2002SecurityPasswordRequirement.  # noqa: E501
        :rtype: int
        """
    ...
    def consecutive_characters_length(self, consecutive_characters_length):
        """Sets the consecutive_characters_length of this InlineResponse2002SecurityPasswordRequirement.

         Specify the max length of consecutive characters(abcde...) that can be used in a passcode. If you set the value of this field to `0`, no restriction will be applied on consecutive characters.   If you would like to set this restriction, you can specify a number between 4 and 8 that define the maximum allowed length for consecutive characters in a passcode.  The max allowed length will be `n-1` where `n` refers to the value you provide for this field.  For instance, if you provide `4` as the value, there can only be a maximum of `3` consecutive characters in a passcode(example: abc1x@8fdh).  # noqa: E501

        :param consecutive_characters_length: The consecutive_characters_length of this InlineResponse2002SecurityPasswordRequirement.  # noqa: E501
        :type: int
        """
    ...
    def have_special_character(self):
        """Gets the have_special_character of this InlineResponse2002SecurityPasswordRequirement.  # noqa: E501

        If the value of this field is set to `true`, the passcode must have at least one special character(!, @, #...).  # noqa: E501

        :return: The have_special_character of this InlineResponse2002SecurityPasswordRequirement.  # noqa: E501
        :rtype: bool
        """
    ...
    def have_special_character(self, have_special_character):
        """Sets the have_special_character of this InlineResponse2002SecurityPasswordRequirement.

        If the value of this field is set to `true`, the passcode must have at least one special character(!, @, #...).  # noqa: E501

        :param have_special_character: The have_special_character of this InlineResponse2002SecurityPasswordRequirement.  # noqa: E501
        :type: bool
        """
    ...
    def minimum_password_length(self):
        """Gets the minimum_password_length of this InlineResponse2002SecurityPasswordRequirement.  # noqa: E501

        Specify a minimum length for the passcode. The passcode length can be from a minimum of 9 characters, up to 14 characters. If you provide `0` as the value of this field, this field will be disabled and not be used and the basic passcode length requirement (minimum of 8 characters) will be applied for the requirement.  # noqa: E501

        :return: The minimum_password_length of this InlineResponse2002SecurityPasswordRequirement.  # noqa: E501
        :rtype: int
        """
    ...
    def minimum_password_length(self, minimum_password_length):
        """Sets the minimum_password_length of this InlineResponse2002SecurityPasswordRequirement.

        Specify a minimum length for the passcode. The passcode length can be from a minimum of 9 characters, up to 14 characters. If you provide `0` as the value of this field, this field will be disabled and not be used and the basic passcode length requirement (minimum of 8 characters) will be applied for the requirement.  # noqa: E501

        :param minimum_password_length: The minimum_password_length of this InlineResponse2002SecurityPasswordRequirement.  # noqa: E501
        :type: int
        """
    ...
    def weak_enhance_detection(self):
        """Gets the weak_enhance_detection of this InlineResponse2002SecurityPasswordRequirement.  # noqa: E501
        ...
        :return: The weak_enhance_detection of this InlineResponse2002SecurityPasswordRequirement.  # noqa: E501
        :rtype: bool
        """
    ...
    def weak_enhance_detection(self, weak_enhance_detection):
        """Sets the weak_enhance_detection of this InlineResponse2002SecurityPasswordRequirement.

        If the value of this field is set to `true`, user passcodes will have to pass detection through a weak passcode dictionary in case hackers use simple passcodes to sign in to your users' accounts.  # noqa: E501

        :param weak_enhance_detection: The weak_enhance_detection of this InlineResponse2002SecurityPasswordRequirement.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InlineResponse2002SecurityPasswordRequirement, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineResponse2002SecurityPasswordRequirement):
            return False
