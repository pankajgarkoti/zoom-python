...
class AccountsaccountIdsettingsInMeeting1(object):
    ...
    def __init__(self, custom_data_center_regions=None, data_center_regions=None):  # noqa: E501
        """AccountsaccountIdsettingsInMeeting1 - a model defined in Swagger"""  # noqa: E501
    ...
    def custom_data_center_regions(self):
        """Gets the custom_data_center_regions of this AccountsaccountIdsettingsInMeeting1.  # noqa: E501
        ...
        :return: The custom_data_center_regions of this AccountsaccountIdsettingsInMeeting1.  # noqa: E501
        :rtype: bool
        """
    ...
    def custom_data_center_regions(self, custom_data_center_regions):
        """Sets the custom_data_center_regions of this AccountsaccountIdsettingsInMeeting1.

        Whether custom [data center regions](https://support.zoom.us/hc/en-us/articles/360042411451-Selecting-data-center-regions-for-meetings-webinars) are in use.  * `true` - Users can [select data center regions](https://support.zoom.us/hc/en-us/articles/360042411451-Selecting-data-center-regions-for-hosted-meetings-and-webinars) to use for hosting real-time meeting traffic. The data center regions can be provided in the `data_center_regions` field.  * `false` - Only the default data center regions.  # noqa: E501

        :param custom_data_center_regions: The custom_data_center_regions of this AccountsaccountIdsettingsInMeeting1.  # noqa: E501
        :type: bool
        """
    ...
    def data_center_regions(self):
        """Gets the data_center_regions of this AccountsaccountIdsettingsInMeeting1.  # noqa: E501
        ...
        :return: The data_center_regions of this AccountsaccountIdsettingsInMeeting1.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def data_center_regions(self, data_center_regions):
        """Sets the data_center_regions of this AccountsaccountIdsettingsInMeeting1.

        If the value of `custom_data_center_regions` is `true`, a comma-separated list of the selected custom [data center regions](https://support.zoom.us/hc/en-us/articles/360059254691-Datacenter-abbreviation-list).  * `AU` - Australia. * `LA` - Latin America.  * `CA` - Canada.  * `CN` - China.  * `DE` - Germany.  * `HK` - Hong Kong SAR.  * `IN` - India.  * `IE` - Ireland.  * `TY` - Japan.  * `MX` - Mexico.  * `NL` - Netherlands.  * `SG` - Singapore.  * `US` - United States.  # noqa: E501

        :param data_center_regions: The data_center_regions of this AccountsaccountIdsettingsInMeeting1.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AccountsaccountIdsettingsInMeeting1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccountsaccountIdsettingsInMeeting1):
            return False
