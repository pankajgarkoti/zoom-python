...
class WebinarSurveyObjectCustomSurveyQuestions(object):
    ...
    def __init__(self, name=None, type=None, answer_required=False, show_as_dropdown=False, answers=None, prompts=None, answer_min_character=None, answer_max_character=None, rating_min_value=None, rating_max_value=None, rating_min_label=None, rating_max_label=None):  # noqa: E501
        """WebinarSurveyObjectCustomSurveyQuestions - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._type = None
    ...
    @property
    def name(self):
        """Gets the name of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501

        The survey question, up to 420 characters.  # noqa: E501

        :return: The name of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this WebinarSurveyObjectCustomSurveyQuestions.

        The survey question, up to 420 characters.  # noqa: E501

        :param name: The name of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        ...
        :return: The type of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this WebinarSurveyObjectCustomSurveyQuestions.

        The survey's question and answer type.  * `single` - Single choice.  * `multiple` - Multiple choice.  * `matching` - Matching.  * `rank_order` - Rank order  * `short_answer` - Short answer  * `long_answer` - Long answer.  * `fill_in_the_blank` - Fill in the blank  * `rating_scale` - Rating scale.  # noqa: E501

        :param type: The type of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :type: str
        """
    ...
    def answer_required(self):
        """Gets the answer_required of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        ...
        :return: The answer_required of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :rtype: bool
        """
    ...
    def answer_required(self, answer_required):
        """Sets the answer_required of this WebinarSurveyObjectCustomSurveyQuestions.

        Whether participants must answer the question.  * `true` - The participant must answer the question.  * `false` - The participant does not need to answer the question.    This value defaults to `false`.  # noqa: E501

        :param answer_required: The answer_required of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :type: bool
        """
    ...
    def show_as_dropdown(self):
        """Gets the show_as_dropdown of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        ...
        :return: The show_as_dropdown of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :rtype: bool
        """
    ...
    def show_as_dropdown(self, show_as_dropdown):
        """Sets the show_as_dropdown of this WebinarSurveyObjectCustomSurveyQuestions.

        Whether to display the radio selection as a drop-down box.  * `true` - Show as a drop-down box.  * `false` - Do not show as a drop-down box.    This value defaults to `false`.  # noqa: E501

        :param show_as_dropdown: The show_as_dropdown of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def answers(self):
        """Gets the answers of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        ...
        :return: The answers of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def answers(self, answers):
        """Sets the answers of this WebinarSurveyObjectCustomSurveyQuestions.

        The survey question's available answers. This field requires a **minimum** of two answers.   * For `single` and `multiple` questions, you can only provide a maximum of 50 answers.  * For `matching` polls, you can only provide a maximum of 16 answers.  * For `rank_order` polls, you can only provide a maximum of seven answers.  # noqa: E501

        :param answers: The answers of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def prompts(self):
        """Gets the prompts of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        ...
        :return: The prompts of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
    ...
    def prompts(self, prompts):
        """Sets the prompts of this WebinarSurveyObjectCustomSurveyQuestions.

        Information about the prompt questions. This field only applies to `matching` and `rank_order` questions. You **must** provide a minimum of two prompts, up to a maximum of 10 prompts.  # noqa: E501

        :param prompts: The prompts of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
    ...
    def answer_min_character(self):
        """Gets the answer_min_character of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        ...
        :return: The answer_min_character of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :rtype: int
        """
    ...
    def answer_min_character(self, answer_min_character):
        """Sets the answer_min_character of this WebinarSurveyObjectCustomSurveyQuestions.

        The allowed minimum number of characters. This field only applies to `short_answer` and `long_answer` questions. You must provide at least a **one** character minimum value.  # noqa: E501

        :param answer_min_character: The answer_min_character of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :type: int
        """
    ...
    def answer_max_character(self):
        """Gets the answer_max_character of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        ...
        :return: The answer_max_character of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :rtype: int
        """
    ...
    def answer_max_character(self, answer_max_character):
        """Sets the answer_max_character of this WebinarSurveyObjectCustomSurveyQuestions.

        The allowed maximum number of characters. This field only applies to `short_answer` and `long_answer` questions.  * For `short_answer` question, a maximum of 500 characters.  * For `long_answer` question, a maximum of 2,000 characters.  # noqa: E501

        :param answer_max_character: The answer_max_character of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :type: int
        """
    ...
    def rating_min_value(self):
        """Gets the rating_min_value of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        ...
        :return: The rating_min_value of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :rtype: int
        """
    ...
    def rating_min_value(self, rating_min_value):
        """Sets the rating_min_value of this WebinarSurveyObjectCustomSurveyQuestions.

        The rating scale's minimum value. This value cannot be less than zero.    This field only applies to the `rating_scale` survey.  # noqa: E501

        :param rating_min_value: The rating_min_value of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :type: int
        """
    ...
    def rating_max_value(self):
        """Gets the rating_max_value of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        ...
        :return: The rating_max_value of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :rtype: int
        """
    ...
    def rating_max_value(self, rating_max_value):
        """Sets the rating_max_value of this WebinarSurveyObjectCustomSurveyQuestions.

        The rating scale's maximum value, up to a maximum value of 10.    This field only applies to the `rating_scale` survey.  # noqa: E501

        :param rating_max_value: The rating_max_value of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :type: int
        """
    ...
    def rating_min_label(self):
        """Gets the rating_min_label of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        ...
        :return: The rating_min_label of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :rtype: str
        """
    ...
    def rating_min_label(self, rating_min_label):
        """Sets the rating_min_label of this WebinarSurveyObjectCustomSurveyQuestions.

        The low score label used for the `rating_min_value` field, up to 50 characters.    This field only applies to the `rating_scale` survey.  # noqa: E501

        :param rating_min_label: The rating_min_label of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :type: str
        """
    ...
    def rating_max_label(self):
        """Gets the rating_max_label of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        ...
        :return: The rating_max_label of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :rtype: str
        """
    ...
    def rating_max_label(self, rating_max_label):
        """Sets the rating_max_label of this WebinarSurveyObjectCustomSurveyQuestions.

        The high score label used for the `rating_max_value` field, up to 50 characters.    This field only applies to the `rating_scale` survey.  # noqa: E501

        :param rating_max_label: The rating_max_label of this WebinarSurveyObjectCustomSurveyQuestions.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(WebinarSurveyObjectCustomSurveyQuestions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WebinarSurveyObjectCustomSurveyQuestions):
            return False
