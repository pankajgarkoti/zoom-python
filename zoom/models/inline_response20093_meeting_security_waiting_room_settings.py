...
class InlineResponse20093MeetingSecurityWaitingRoomSettings(object):
    ...
    def __init__(self, participants_to_place_in_waiting_room=None, users_who_can_admit_participants_from_waiting_room=None, whitelisted_domains_for_waiting_room=None):  # noqa: E501
        """InlineResponse20093MeetingSecurityWaitingRoomSettings - a model defined in Swagger"""  # noqa: E501
    ...
    def participants_to_place_in_waiting_room(self):
        """Gets the participants_to_place_in_waiting_room of this InlineResponse20093MeetingSecurityWaitingRoomSettings.  # noqa: E501
        ...
        :return: The participants_to_place_in_waiting_room of this InlineResponse20093MeetingSecurityWaitingRoomSettings.  # noqa: E501
        :rtype: int
        """
    ...
    def participants_to_place_in_waiting_room(self, participants_to_place_in_waiting_room):
        """Sets the participants_to_place_in_waiting_room of this InlineResponse20093MeetingSecurityWaitingRoomSettings.

        The type of participants to be admitted to the Waiting Room:  * `0` - All attendees.  * `1` - Users who are not in your account.  * `2` - Users who are not in your account and are not part of your [allowed domains list](https://support.zoom.us/hc/en-us/articles/360037117472-Configuring-authentication-profiles#h_e3cf0d5f-eec7-4c2a-ad29-ef2a5079a7da).  # noqa: E501

        :param participants_to_place_in_waiting_room: The participants_to_place_in_waiting_room of this InlineResponse20093MeetingSecurityWaitingRoomSettings.  # noqa: E501
        :type: int
        """
    ...
    def users_who_can_admit_participants_from_waiting_room(self):
        """Gets the users_who_can_admit_participants_from_waiting_room of this InlineResponse20093MeetingSecurityWaitingRoomSettings.  # noqa: E501
        ...
        :return: The users_who_can_admit_participants_from_waiting_room of this InlineResponse20093MeetingSecurityWaitingRoomSettings.  # noqa: E501
        :rtype: int
        """
    ...
    def users_who_can_admit_participants_from_waiting_room(self, users_who_can_admit_participants_from_waiting_room):
        """Sets the users_who_can_admit_participants_from_waiting_room of this InlineResponse20093MeetingSecurityWaitingRoomSettings.

        The users who can admit participants from the Waiting Room:  * `0` - Host and co-hosts only.  * `1` - Host, co-hosts, and anyone who bypassed the Waiting Room if the host and co-hosts are not present.  # noqa: E501

        :param users_who_can_admit_participants_from_waiting_room: The users_who_can_admit_participants_from_waiting_room of this InlineResponse20093MeetingSecurityWaitingRoomSettings.  # noqa: E501
        :type: int
        """
    ...
    def whitelisted_domains_for_waiting_room(self):
        """Gets the whitelisted_domains_for_waiting_room of this InlineResponse20093MeetingSecurityWaitingRoomSettings.  # noqa: E501
        ...
        :return: The whitelisted_domains_for_waiting_room of this InlineResponse20093MeetingSecurityWaitingRoomSettings.  # noqa: E501
        :rtype: str
        """
    ...
    def whitelisted_domains_for_waiting_room(self, whitelisted_domains_for_waiting_room):
        """Sets the whitelisted_domains_for_waiting_room of this InlineResponse20093MeetingSecurityWaitingRoomSettings.

        If the `participants_to_place_in_waiting_room` field is `2`, a comma-separated list of the domains that can bypass the Waiting Room (`example.com,example2.com`).  # noqa: E501

        :param whitelisted_domains_for_waiting_room: The whitelisted_domains_for_waiting_room of this InlineResponse20093MeetingSecurityWaitingRoomSettings.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InlineResponse20093MeetingSecurityWaitingRoomSettings, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InlineResponse20093MeetingSecurityWaitingRoomSettings):
            return False
