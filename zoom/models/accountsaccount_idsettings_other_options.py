...
class AccountsaccountIdsettingsOtherOptions(object):
    ...
    def __init__(self, allow_auto_active_users=None, allow_users_contact_support_via_chat=None, allow_users_enter_and_share_pronouns=None, blur_snapshot=None, display_meetings_scheduled_for_others=None, meeting_qos_and_mos=None, show_one_user_meeting_on_dashboard=None, use_cdn=None, webinar_registration_options=None, email_in_attendee_report_for_meeting=None):  # noqa: E501
        """AccountsaccountIdsettingsOtherOptions - a model defined in Swagger"""  # noqa: E501
    ...
    def allow_auto_active_users(self):
        """Gets the allow_auto_active_users of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        ...
        :return: The allow_auto_active_users of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_auto_active_users(self, allow_auto_active_users):
        """Sets the allow_auto_active_users of this AccountsaccountIdsettingsOtherOptions.

        If true, administrators can activate users with a single default passcode when adding users. This activates added users immediately without waiting for them to set their own passcode.  # noqa: E501

        :param allow_auto_active_users: The allow_auto_active_users of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        :type: bool
        """
    ...
    def allow_users_contact_support_via_chat(self):
        """Gets the allow_users_contact_support_via_chat of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501

        If true, displays the Zoom Help badge on the bottom-right of the page.  # noqa: E501

        :return: The allow_users_contact_support_via_chat of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_users_contact_support_via_chat(self, allow_users_contact_support_via_chat):
        """Sets the allow_users_contact_support_via_chat of this AccountsaccountIdsettingsOtherOptions.

        If true, displays the Zoom Help badge on the bottom-right of the page.  # noqa: E501

        :param allow_users_contact_support_via_chat: The allow_users_contact_support_via_chat of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        :type: bool
        """
    ...
    def allow_users_enter_and_share_pronouns(self):
        """Gets the allow_users_enter_and_share_pronouns of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501

        If true, users can add pronouns to their profile cards and share them during meetings and webinars.  # noqa: E501

        :return: The allow_users_enter_and_share_pronouns of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_users_enter_and_share_pronouns(self, allow_users_enter_and_share_pronouns):
        """Sets the allow_users_enter_and_share_pronouns of this AccountsaccountIdsettingsOtherOptions.

        If true, users can add pronouns to their profile cards and share them during meetings and webinars.  # noqa: E501

        :param allow_users_enter_and_share_pronouns: The allow_users_enter_and_share_pronouns of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        :type: bool
        """
    ...
    def blur_snapshot(self):
        """Gets the blur_snapshot of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        ...
        :return: The blur_snapshot of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        :rtype: bool
        """
    ...
    def blur_snapshot(self, blur_snapshot):
        """Sets the blur_snapshot of this AccountsaccountIdsettingsOtherOptions.

        If true, iOS blurs the screenshot in the task switcher when multiple apps are open. Android hides the screenshot in the system-level list of recent apps.  # noqa: E501

        :param blur_snapshot: The blur_snapshot of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        :type: bool
        """
    ...
    def display_meetings_scheduled_for_others(self):
        """Gets the display_meetings_scheduled_for_others of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        ...
        :return: The display_meetings_scheduled_for_others of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        :rtype: bool
        """
    ...
    def display_meetings_scheduled_for_others(self, display_meetings_scheduled_for_others):
        """Sets the display_meetings_scheduled_for_others of this AccountsaccountIdsettingsOtherOptions.

        If true, a user with [scheduling privileges](https://support.zoom.us/hc/en-us/articles/201362803-Scheduling-privilege) can view other users' meetings.  # noqa: E501

        :param display_meetings_scheduled_for_others: The display_meetings_scheduled_for_others of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        :type: bool
        """
    ...
    def meeting_qos_and_mos(self):
        """Gets the meeting_qos_and_mos of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        ...
        :return: The meeting_qos_and_mos of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        :rtype: int
        """
    ...
    def meeting_qos_and_mos(self, meeting_qos_and_mos):
        """Sets the meeting_qos_and_mos of this AccountsaccountIdsettingsOtherOptions.

        The dashboard meeting [quality scores and network alerts](https://support.zoom.us/hc/en-us/articles/360061244651) setting.  * `0` - Do not enable meeting quality scores and network alerts on the dashboard.  * `1` - Display the meeting quality score and network alerts on the dashboard.  * `2` - Use custom thresholds for quality scores and network alerts. * `3` - Display the meeting quality score and network alerts on the dashboard and use custom thresholds for quality scores and network alerts.  # noqa: E501

        :param meeting_qos_and_mos: The meeting_qos_and_mos of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        :type: int
        """
    ...
    def show_one_user_meeting_on_dashboard(self):
        """Gets the show_one_user_meeting_on_dashboard of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501

        If true, meetings with only one person will display on the dashboard and in reports.  # noqa: E501

        :return: The show_one_user_meeting_on_dashboard of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        :rtype: bool
        """
    ...
    def show_one_user_meeting_on_dashboard(self, show_one_user_meeting_on_dashboard):
        """Sets the show_one_user_meeting_on_dashboard of this AccountsaccountIdsettingsOtherOptions.

        If true, meetings with only one person will display on the dashboard and in reports.  # noqa: E501

        :param show_one_user_meeting_on_dashboard: The show_one_user_meeting_on_dashboard of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def use_cdn(self):
        """Gets the use_cdn of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        ...
        :return: The use_cdn of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        :rtype: str
        """
    ...
    def use_cdn(self, use_cdn):
        """Sets the use_cdn of this AccountsaccountIdsettingsOtherOptions.

        Allow connections to different CDNs (content delivery networks) for a better web browsing experience. All users in your organization will use the selected CDN to access static resources.  * `none` - Do not use a CDN.  * `default` - Use the Amazon CloudFront CDN for users **except** Chinese Mainland users. Chinese Mainland users will use the Wangsu CDN (China).  * `wangsu` - Use the Wangsu CDN for all users.  # noqa: E501

        :param use_cdn: The use_cdn of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        :type: str
        """
    ...
    def webinar_registration_options(self):
        """Gets the webinar_registration_options of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501


        :return: The webinar_registration_options of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
    ...
    def webinar_registration_options(self, webinar_registration_options):
        """Sets the webinar_registration_options of this AccountsaccountIdsettingsOtherOptions.


        :param webinar_registration_options: The webinar_registration_options of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
    ...
    def email_in_attendee_report_for_meeting(self):
        """Gets the email_in_attendee_report_for_meeting of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501

        If true, include authenticated guests' email addresses in attendee reports for meetings.  # noqa: E501

        :return: The email_in_attendee_report_for_meeting of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        :rtype: bool
        """
    ...
    def email_in_attendee_report_for_meeting(self, email_in_attendee_report_for_meeting):
        """Sets the email_in_attendee_report_for_meeting of this AccountsaccountIdsettingsOtherOptions.

        If true, include authenticated guests' email addresses in attendee reports for meetings.  # noqa: E501

        :param email_in_attendee_report_for_meeting: The email_in_attendee_report_for_meeting of this AccountsaccountIdsettingsOtherOptions.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AccountsaccountIdsettingsOtherOptions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccountsaccountIdsettingsOtherOptions):
            return False
