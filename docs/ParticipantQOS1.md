...
**mac_addr** | **str** | The participant&#x27;s MAC address.   **Note:** This response returns an empty string value for any users who are **not** a part of the host&#x27;s account, such as external users. | [optional] 
**pc_name** | **str** | The participant&#x27;s PC name. | [optional] 
**user_id** | **str** | The participant&#x27;s ID. This value is assigned to a participant when they joining a meeting, and is only valid for the meeting&#x27;s duration. | [optional] 
