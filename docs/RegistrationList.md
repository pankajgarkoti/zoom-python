...
**page_number** | **int** | **Deprecated** This field will be deprecated. We will no longer support this field in a future release. Instead, use &#x60;next_page_token&#x60; for pagination. | [optional] [default to 1]
...
**registrants** | [**list[RegistrationListRegistrants]**](RegistrationListRegistrants.md) | List of registrant objects. | [optional] 
